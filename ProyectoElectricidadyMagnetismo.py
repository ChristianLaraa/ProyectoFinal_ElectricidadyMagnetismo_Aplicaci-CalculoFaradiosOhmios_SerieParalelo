...
def mostrar_portada_empresa():
    ...
    # Agrega un texto centrado
    texto_empresa = "Hernandez Miranda Jorge Eduardo"
    label_texto_empresa = tk.Label(ventana_portada, text=texto_empresa, font=("Arial", 20))
    label_texto_empresa.pack(pady=1)  # Espaciado vertical
    
    texto_empresa = "Valencia Contreras Jose Mateo"
    label_texto_empresa = tk.Label(ventana_portada, text=texto_empresa, font=("Arial", 20))
    label_texto_empresa.pack(pady=1)  # Espaciado vertical
...
image_resistencia_serie = Image.open(r"C:\Users\chris\OneDrive\Escritorio\Proyecto_ElectricidadyMagnetismo\ResistenciaSerie (3).gif")
image_resistencia_serie = ImageTk.PhotoImage(image_resistencia_serie)

image_resistencia_paralelo = Image.open(r"C:\Users\chris\OneDrive\Escritorio\Proyecto_ElectricidadyMagnetismo\ResistenciaParalelo (2).gif")
...
label_tipo_resistencia = tk.Label(image_frame_resistencia, text="Seleccione el tipo de resistencia:", font=("Arial", 11
                                                                                                            ))
...
add_resistor_button = tk.Button(resistencia_frame, text="Agregar Campos de Resistencias", command=add_resistor_entry, font=("Arial", 11), bg="blue", fg="white")
add_resistor_button.pack(pady=(2, 5))




calc_button = tk.Button(resistencia_frame, text="Calcular en Ω", command=calc_resistencia, font=("Arial", 11), bg="green", fg="white")
calc_button.pack()
...
add_capacitor_button.pack(pady=(3, 9))  # Ajuste el valor de pady según sea necesario
...
mostrar_portada_button = tk.Button(root, text="Mostrar los datos de la Empresa", command=mostrar_portada_empresa, width=30, bg="red", fg="white", font=("Arial", 12))
